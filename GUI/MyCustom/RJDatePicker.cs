...
namespace GUI.MyCustom
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = GUI.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = GUI.Properties.Resources.calendarDark;
                else calendarIcon = GUI.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
